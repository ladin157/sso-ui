...
var SsoAuthorization = function (sso, options) {
    var _instance = this;
    this.rpt = null;
    ...
    this.init = function () {
        ...
        request.open('GET', sso.authServerUrl + '/realms/' + sso.realm + '/.well-known/uma2-configuration');
    ...
    this.authorize = function (authorizationRequest) {
        this.then = function (onGrant, onDeny, onError) {
            if (authorizationRequest && authorizationRequest.ticket) {
                ...
                request.setRequestHeader('Authorization', 'Bearer ' + sso.token);
                ...
                var params = "grant_type=urn:ietf:params:oauth:grant-type:uma-ticket&client_id=" + sso.clientId + "&ticket=" + authorizationRequest.ticket;
    ...
    this.entitlement = function (resourceServerId, authorizationRequest) {
        this.then = function (onGrant, onDeny, onError) {
            ...
            var params = "grant_type=urn:ietf:params:oauth:grant-type:uma-ticket&client_id=" + sso.clientId;
